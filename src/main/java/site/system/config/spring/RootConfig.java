package site.system.config.spring;

import com.mchange.v2.c3p0.ComboPooledDataSource;
import site.system.utils.PropertiesUtil;
import site.system.utils.SystemConstants;
...
@ComponentScan({"site.service", "site.dao"})
public class RootConfig {
    ...
    public LocalSessionFactoryBean sessionFactoryBean() throws PropertyVetoException {
        ...
        sessionFactoryBean.setPackagesToScan("site.model");
